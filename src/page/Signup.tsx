                    ...
                    <div className="px-6">
                        ...
                        <div className=" mt-12 flex flex-col w-full ">
                          <div className="text-center mb-3">
                            <h1 className="font-extrabold text-[#B51B75] text-3xl">SignUp</h1>
                          </div>
                            <div className="w-full flex justify-center font-bold mb-4">
                            
                                    <form onSubmit={handleSubmit}>
                                    <div className="w-full flex border border-gray-700">
                                        <div className="bg-gray-200 p-2"><FaUserAlt className="text-3xl"/></div>
                                      
                                      <input type="text" className="w-full border-none" placeholder="Enter your name" value={name} onChange={(e)=>setName(e.target.value)} />
                                      </div>
                                      ...
                                      <input type="text" className="w-full border-none" placeholder="Enter your email" value={email} onChange={(e)=>setEmail(e.target.value)}/>
                                      </div>

                                      <div className="w-full mt-2 flex border border-gray-700">
                                        <div className="bg-gray-200 p-2"><FaKey className="text-2xl"/></div>
                                      
                                      <input type={passwordView ? 'text' : 'password'} className="w-full border-none" placeholder="Enter your password" value={password} onChange={(e)=>setPassword(e.target.value)}/>
                                      ...
                                      <input type={confirmPasswordView ? 'text' : 'password'} className="w-full border-none" placeholder="Re-enter the password" value={cPassword} onChange={(e)=>setCPassword(e.target.value)}/>
                                     
                                      <div className="bg-gray-200 p-2 text-2xl cursor-pointer" onClick={()=>setConfirmPasswordView(!confirmPasswordView)}>{confirmPasswordView ? <FaEye /> : <IoMdEyeOff/>}</div>
                                      </div>
                                      <div className="flex justify-end mt-2">
                                        <Link to='/'>
                                        <p className="text-sm font-medium text-blue-950">Already have account</p>
                                        </Link>
                                      </div>
